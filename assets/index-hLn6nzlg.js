...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function Ua(){return new Mn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:mo(),fragmentShader:`
		...
		`,blending:Nn,depthTest:!1,depthWrite:!1})}function Fa(){return new Mn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:mo(),fragmentShader:`
...
`)}function Qp(i,t){const e={},n=i.getProgramParameter(t,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(t,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),e[a]={type:r.type,location:i.getAttribLocation(t,a),locationSize:o}}return e}function wi(i){return i!==""}function Xa(i,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function $a(i,t){return i.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const tm=/^[ \t]*#include +<([\w\d./]+)>/gm;function Jr(i){return i.replace(tm,nm)}const em=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function nm(i,t){let e=Bt[t];if(e===void 0){const n=em.get(t);if(n!==void 0)e=Bt[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Jr(e)}const im=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function qa(i){return i.replace(im,sm)}function sm(i,t,e,n){let s="";for(let r=parseInt(t);r<parseInt(e);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Ya(i){let t=`precision ${i.precision} float;
...
#define LOW_PRECISION`),t}function rm(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===_l?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===vl?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===_n&&(t="SHADOWMAP_TYPE_VSM"),t}function om(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Pi:case Di:t="ENVMAP_TYPE_CUBE";break;case Zs:t="ENVMAP_TYPE_CUBE_UV";break}return t}function am(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Di:t="ENVMAP_MODE_REFRACTION";break}return t}function lm(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case xl:t="ENVMAP_BLENDING_MULTIPLY";break;case zc:t="ENVMAP_BLENDING_MIX";break;case Hc:t="ENVMAP_BLENDING_ADD";break}return t}function cm(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function hm(i,t,e,n){const s=i.getContext(),r=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=rm(e),c=om(e),h=am(e),d=lm(e),f=cm(e),m=e.isWebGL2?"":jp(e),g=Jp(e),S=Kp(r),p=s.createProgram();let u,y,v=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+y);const E=v+u+a,D=v+y+o,C=ka(s,s.VERTEX_SHADER,E),w=ka(s,s.FRAGMENT_SHADER,D);s.attachShader(p,C),s.attachShader(p,w),e.index0AttributeName!==void 0?s.bindAttribLocation(p,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(p,0,"position"),s.linkProgram(p);function B(nt){if(i.debug.checkShaderErrors){const J=s.getProgramInfoLog(p).trim(),L=s.getShaderInfoLog(C).trim(),W=s.getShaderInfoLog(w).trim();let G=!0,Y=!0;if(s.getProgramParameter(p,s.LINK_STATUS)===!1)if(G=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,p,C,w);else{const V=Wa(s,C,"vertex"),$=Wa(s,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(p,s.VALIDATE_STATUS)+`
...
}`;function Yg(i){const t=document.createElement("style");t.innerHTML=i;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let hl=!1;class So{constructor({parent:t,autoPlace:e=t===void 0,container:n,width:s,title:r="Controls",closeFolders:a=!1,injectStyles:o=!0,touchStyles:l=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",c=>{(c.code==="Enter"||c.code==="Space")&&(c.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(r),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),l&&this.domElement.classList.add("allow-touch-styles"),!hl&&o&&(Yg(qg),hl=!0),n?n.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),s&&this.domElement.style.setProperty("--width",s+"px"),this._closeFolders=a}add(t,e,n,s,r){if(Object(n)===n)return new Xg(this,t,e,n);const a=t[e];switch(typeof a){case"number":return new Wg(this,t,e,n,s,r);case"boolean":return new Og(this,t,e);case"string":return new $g(this,t,e);case"function":return new zr(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,a)}addColor(t,e,n=1){return new kg(this,t,e,n)}addFolder(t){const e=new So({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(n=>{n instanceof zr||n._name in t.controllers&&n.load(t.controllers[n._name])}),e&&t.folders&&this.folders.forEach(n=>{n._title in t.folders&&n.load(t.folders[n._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(n=>{if(!(n instanceof zr)){if(n._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${n._name}"`);e.controllers[n._name]=n.save()}}),t&&this.folders.forEach(n=>{if(n._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${n._title}"`);e.folders[n._title]=n.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const n=r=>{r.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",n))};this.$children.addEventListener("transitionend",n);const s=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=s+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(n=>n.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}function Cn(i,t){if(!{}.hasOwnProperty.call(i,t))throw new TypeError("attempted to use private field on non-instance");return i}var Zg=0;function jg(i){return"__private_"+Zg+++"_"+i}var Se=jg("gui");class Jg{get gui(){return Cn(this,Se)[Se]}constructor(){Object.defineProperty(this,Se,{writable:!0,value:null}),this.init()}init(){this.hashChange=this.hashChange.bind(this),this.hashChange(),window.addEventListener("hashchange",this.hashChange,!1)}hashChange(){location.hash.includes("debug")?Cn(this,Se)[Se]=new So:Cn(this,Se)[Se]&&(Cn(this,Se)[Se].destroy(),Cn(this,Se)[Se]=null)}destroy(){window.removeEventListener("hashchange",this.hashChange,!1),Cn(this,Se)[Se]&&(Cn(this,Se)[Se].destroy(),Cn(this,Se)[Se]=null)}}function zs(i,t){if(!{}.hasOwnProperty.call(i,t))throw new TypeError("attempted to use private field on non-instance");return i}var Kg=0;function Qg(i){return"__private_"+Kg+++"_"+i}function so(i,t){if(typeof t!="object"||t===null)return i;for(const e in t)t.hasOwnProperty(e)&&(typeof t[e]=="object"&&t[e]!==null?((typeof i[e]!="object"||i[e]===null)&&(i[e]=Array.isArray(t[e])?[]:{}),so(i[e],t[e])):i[e]=t[e]);return i}const ge={GAME:"game",SCORES:"scores",PREFERENCES:"preferences"};var gn=Qg("listeners");class t_{constructor(){Object.defineProperty(this,gn,{writable:!0,value:{[ge.GAME]:[],[ge.SCORES]:[],[ge.PREFERENCES]:[]}}),this.state={[ge.GAME]:{2:{time:null,cubeData:null},3:{time:null,cubeData:null},4:{time:null,cubeData:null},5:{time:null,cubeData:null}},[ge.SCORES]:{2:{scores:[],solves:0,best:0,worst:0},3:{scores:[],solves:0,best:0,worst:0},4:{scores:[],solves:0,best:0,worst:0},5:{scores:[],solves:0,best:0,worst:0}},[ge.PREFERENCES]:{cubeSize:3,controlsRotationType:0,controlsFlipType:1,scramblerDificulty:1,cameraFov:30}},this.load(ge.GAME),this.load(ge.SCORES),this.load(ge.PREFERENCES)}setState(t,e){so(this.state[t],e),this.save(t),this.notify(t)}subscribe(t,e){return zs(this,gn)[gn][t].push(e)}unsubscribe(t,e){const n=zs(this,gn)[gn][t].findIndex(s=>s===e);if(n>-1)return zs(this,gn)[gn][t].splice(n,1)}notify(t){zs(this,gn)[gn][t].forEach(e=>e(this.state[t]))}load(t){const e=JSON.parse(localStorage.getItem(t));e&&so(this.state[t],e),this.save(t)}save(t){localStorage.setItem(t,JSON.stringify(this.state[t]))}clear(t){localStorage.removeItem(t)}}class e_{get colors(){return this.themes[this.theme]}constructor(){this.theme="cube",this.themes={cube:{U:16775167,D:16772936,F:15677731,R:4303560,B:16747530,L:8571448,P:528410,G:13751771},erno:{U:16777215,D:16766208,F:12852794,R:20922,B:16734208,L:40544,P:528410,G:9092607},dust:{U:16774891,D:15189133,F:9381182,R:6323817,B:12480354,L:8691549,P:528410,G:15189133},camo:{U:16774891,D:12564082,F:3613724,R:7439446,B:8411185,L:3621661,P:528410,G:12564082},rain:{U:16448255,D:15579437,F:13508917,R:4496009,B:15489071,L:10725703,P:528410,G:8894892}}}setTheme(t){this.theme=t}}const ul=(()=>{let i=0;class t{constructor(){this.ids=[],this.animations={},this.update=this.update.bind(this),this.raf=0,this.time=0}update(){const n=performance.now(),s=n-this.time;this.time=n;let r=this.ids.length;for(this.raf=r?requestAnimationFrame(this.update):0;r--;)this.animations[this.ids[r]]&&this.animations[this.ids[r]].update(s)}add(n){n.id=i++,this.ids.push(n.id),this.animations[n.id]=n,this.raf===0&&(this.time=performance.now(),this.raf=requestAnimationFrame(this.update))}remove(n){const s=this.ids.indexOf(n.id);s<0||(this.ids.splice(s,1),delete this.animations[n.id],n=null)}}return new t})();class oc{constructor(t){t===!0&&this.start()}start(){ul.add(this)}stop(){ul.remove(this)}update(t){}}const Me={Power:{In:i=>(i=Math.round(i||1),t=>Math.pow(t,i)),Out:i=>(i=Math.round(i||1),t=>1-Math.abs(Math.pow(t-1,i))),InOut:i=>(i=Math.round(i||1),t=>t<.5?Math.pow(t*2,i)/2:(1-Math.abs(Math.pow(t*2-1-1,i)))/2+.5)},Sine:{In:()=>i=>1+Math.sin(Math.PI/2*i-Math.PI/2),Out:()=>i=>Math.sin(Math.PI/2*i),InOut:()=>i=>(1+Math.sin(Math.PI*i-Math.PI/2))/2},Back:{Out:i=>(i=i||1.70158,t=>(t-=1)*t*((i+1)*t+i)+1),In:i=>(i=i||1.70158,t=>t*t*((i+1)*t-i))},Elastic:{Out:(i,t)=>{let e=Math.PI*2,n=i>=1?i:1,s=(t||.3)/(i<1?i:1),r=s/e*(Math.asin(1/n)||0);return s=e/s,a=>n*Math.pow(2,-10*a)*Math.sin((a-r)*s)+1}},Linear:{None:()=>i=>i}};class ze extends oc{constructor(t){super(!1),this.duration=t.duration||500,this.easing=t.easing||Me.Linear.None(),this.onUpdate=t.onUpdate||(()=>{}),this.onComplete=t.onComplete||(()=>{}),this.delay=t.delay||!1,this.yoyo=t.yoyo?!1:null,this.progress=0,this.value=0,this.delta=0,this.complete=!1,this.getFromTo(t),this.delay?setTimeout(()=>super.start(),this.delay):super.start(),this.onUpdate(this)}update(t){const e=this.value,n=this.yoyo===!0?-1:1;this.progress+=t/this.duration*n,this.yoyo===null&&this.progress>1?(this.progress=1,this.value=1,this.complete=!0):this.value=this.easing(this.progress),this.delta=this.value-e,this.onUpdate(this),this.values!==null&&this.updateFromTo(),this.yoyo!==null&&this.updateYoyo(),this.complete&&(this.onComplete(this),super.stop())}updateYoyo(){(this.progress>1||this.progress<0)&&(this.value=this.progress=this.progress>1?1:0,this.yoyo=!this.yoyo),this.onUpdate(this)}updateFromTo(){this.values.forEach(t=>{this.target[t]=this.from[t]+(this.to[t]-this.from[t])*this.value})}getFromTo(t){if(!t.target||!t.to){this.values=null;return}this.target=t.target||null,this.from=t.from||{},this.to=t.to||null,this.values=[],Object.keys(this.from).length<1&&Object.keys(this.to).forEach(e=>{this.from[e]=this.target[e]}),Object.keys(this.to).forEach(e=>{this.values.push(e)})}}class on{constructor(t){this.type=on.SWITCH.TURNOFF,this.aLight=this.addAmbientLight(),this.pLight=this.addPointLight(),t.scene.add(this.aLight),t.scene.add(this.pLight)}addAmbientLight(){return new wg("white",4)}addPointLight(){const t=new Ag("white",0,0,0);return t.position.set(0,4,0),t.penumbra=.5,t.castShadow=!0,t.shadow.camera.far=8,t.shadow.mapSize.set(256,256),t.shadow.normalBias=.05,t}switch(t,e=750){if(t===this.type)return;this.type=t;const n=t===on.SWITCH.TURNON?Me.Power.In():Me.Power.Out();switch(t){case on.SWITCH.TURNON:new ze({easing:n,duration:e,onUpdate:s=>{this.pLight.intensity=s.value*32,this.pLight.angle=s.value*Math.PI/8}});break;case on.SWITCH.TURNOFF:new ze({easing:n,delay:200,duration:e-200,onUpdate:s=>{this.pLight.intensity=(1-s.value)*32,this.pLight.angle=(1-s.value)*Math.PI/8}});break}}}on.SWITCH={TURNON:!0,TURNOFF:!1};const n_=`
/**
...
#endif
`;class i_{constructor(t){const e=new li(8,8,1,1),n=new nc({color:"white"});n.onBeforeCompile=r=>{r.fragmentShader=r.fragmentShader.replace("#include <lights_fragment_begin>",n_.replace("getAmbientLightIrradiance( ambientLightColor )","vec3(0.0)"))};const s=new Ie(e,n);s.receiveShadow=!0,s.rotateX(-Math.PI*.5),s.position.y=-1.5,t.scene.add(s)}}var s_=`precision highp float;
